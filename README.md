...
![circloO companion banner](assets/circloo-companion_banner.png)
...
- **open source** -- i contributed to [Prism Launcher](https://github.com/PrismLauncher/PrismLauncher) ([#5414](https://github.com/PrismLauncher/PrismLauncher/pull/5414), [#5418](https://github.com/PrismLauncher/PrismLauncher/pull/5418)) and to some other projects as well
...
- [**TrainStatusIcons**](https://github.com/qaptivator/TrainStatusIcons) -- ***Factorio mod*** which adds the train status icons mentioned in the FFF blog, with ***5.5 thousand downloads***. this is also scrapped just because Factorio 2.0, adding this feature anyway, released just a month later, so this is maybe only ever useful for people who play older Factorio for some reason. i'm still proud of this project though, it got many downloads from the mod page (5.5k!), and i had a nice time sharing this to eveyrone.<br><img src="assets/TrainStatusIcons_banner.png" width="500" />
- [**everyexport**](https://modrinth.com/mod/everyexport) -- simple fabric minecraft mod to export all item and recipe data from the game. useful if you're an advanced tech player in mc, i guess. here, i also trained my java/kotlin knowledge.<br><img src="assets/everyexport_banner.png" width="500" />
